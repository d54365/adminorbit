...
from apps.core.models import BaseManager, TenantBaseModel, ForeignKey


class TenantUserManager(BaseUserManager, BaseManager):
    @staticmethod
...
class TenantUser(AbstractBaseUser, TenantBaseModel):
    """租户用户"""
